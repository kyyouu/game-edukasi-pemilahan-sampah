...
export const conveyorItems = [
  ...
  { id: 'c3',  name: 'Baterai Bekas',   emoji: '🔋', category: 2, hint: 'Baterai mengandung merkuri dan logam berat yang sangat berbahaya → B3!' },
  ...
  { id: 'c6',  name: 'Obat Kadaluarsa', emoji: '💊', category: 2, hint: 'Obat kadaluarsa mengandung zat kimia berbahaya → B3!' },
  ...
  { id: 'c9',  name: 'Lampu Neon',      emoji: '💡', category: 2, hint: 'Lampu neon mengandung merkuri yang sangat beracun → B3!' },
  ...
  { id: 'c12', name: 'Cat Bekas',       emoji: '🎨', category: 2, hint: 'Cat mengandung bahan kimia pelarut yang berbahaya → B3!' },
  ...
  { id: 'c15', name: 'Aki Bekas',       emoji: '⚡', category: 2, hint: 'Aki bekas mengandung asam sulfat dan timbal yang sangat berbahaya → B3!' },
];
...
export const detectiveCases = [
  ...
  },
  {
    ...
    name: 'Baterai Bekas',
    emoji: '🔋',
    mission: 'Ada baterai bekas tertinggal di dekat sumur warga. Selidiki!',
    category: 2, // B3
    categoryName: 'B3',
    clues: [
      { id: 'cl3a', text: 'Mengandung merkuri dan logam berat',       isRelevant: true  },
      { id: 'cl3b', text: 'Berbahaya jika bocor ke dalam tanah',      isRelevant: true  },
      { id: 'cl3c', text: 'Harus dibawa ke tempat pengumpulan khusus',isRelevant: true  },
      { id: 'cl3d', text: 'Bisa dimakan oleh hewan ternak',           isRelevant: false },
      { id: 'cl3e', text: 'Berasal dari sisa sayuran',                isRelevant: false },
      { id: 'cl3f', text: 'Bisa menjadi pupuk yang bagus',            isRelevant: false },
    ],
    conclusion: 'Baterai mengandung zat kimia berbahaya yang bisa mencemari tanah dan air. Ini Limbah B3!',
    actions: [
      { text: 'Ditimbun di pekarangan',                    correct: false },
      { text: 'Dibawa ke drop point B3', correct: true  },
      { text: 'Dibuang ke tempat sampah biasa',            correct: false },
      { text: 'Direndam dalam air',                        correct: false },
    ],
    actionExplanation: 'Baterai bekas WAJIB dibawa ke tempat pengumpulan B3 khusus — jangan dibuang sembarangan!',
  },
  {
    id: 'det4',
    name: 'Kaleng Minuman',
  ...
  },
  {
    ...
    name: 'Lampu Bekas',
    emoji: '💡',
    mission: 'Lampu neon bekas ditemukan di tempat sampah. Ini berbahaya! Selidiki!',
    category: 2, // B3
    categoryName: 'B3',
    clues: [
      { id: 'cl6a', text: 'Mengandung gas merkuri di dalamnya',       isRelevant: true  },
      { id: 'cl6b', text: 'Berbahaya jika pecah dan terhirup',        isRelevant: true  },
      { id: 'cl6c', text: 'Harus dibuang ke tempat B3 khusus',        isRelevant: true  },
      { id: 'cl6d', text: 'Bisa langsung dibuang ke tempat sampah',   isRelevant: false },
      { id: 'cl6e', text: 'Terbuat dari bahan organik alami',         isRelevant: false },
      { id: 'cl6f', text: 'Aman dimainkan oleh anak-anak',            isRelevant: false },
    ],
    conclusion: 'Lampu neon mengandung merkuri berbahaya. Jika pecah bisa mencemari udara. Ini Limbah B3!',
    actions: [
      { text: 'Dipecahkan agar muat di tempat sampah', correct: false },
      { text: 'Dibawa ke pengumpul B3 khusus',      correct: true  },
      { text: 'Dibuang ke tempat sampah biasa',        correct: false },
      { text: 'Dikubur di halaman belakang',           correct: false },
    ],
    actionExplanation: 'Lampu neon HARUS dibawa ke fasilitas pengolahan B3 — jangan dipecah atau dibuang sembarangan!',
  },
  {
    id: 'det7',
    name: 'Kertas Koran',
